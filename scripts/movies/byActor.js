...
form.addEventListener("submit", (e)=>{
    ...
    let byActor = document.getElementById("byActor");
...
//List movies by set actor again after page change.
...
//List movies by set actor with set genre.
function genres(){
    let actorId = sessionStorage.getItem("theActorId");
...
//Change page, displaying movies by set actor with the set genre.
...
//Reset button. Reset the set actor and genre.
...
//Clear session storage from genres on page load.
